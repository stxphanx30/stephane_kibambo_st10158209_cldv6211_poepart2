...
namespace poe.Models
{
    public class ProductDisplayModel
    {
        ...
        public static List<ProductDisplayModel> SelectProducts()
        {
            ...
            string con_string = "Server=tcp:cldv-server-sql.database.windows.net,1433;Initial Catalog=cldv-DB;Persist Security Info=False;User ID=stephane-kib;Password=CTMMonecole1@;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30";
